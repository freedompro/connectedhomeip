...
@property (nonatomic, copy) NSNumber * _Nullable attributeId  MTR_DEPRECATED("Please use attributeID", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
...
@property (nonatomic, copy) MTRAccessControlClusterAccessControlEntryStruct * _Nullable latestValue  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@property (nonatomic, copy) NSNumber * _Nonnull fabricIndex  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@end
...
@property (nonatomic, copy) NSNumber * _Nullable adminPasscodeID  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@property (nonatomic, copy) NSNumber * _Nonnull changeType  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@property (nonatomic, copy) MTRAccessControlClusterAccessControlExtensionStruct * _Nullable latestValue  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@property (nonatomic, copy) NSNumber * _Nonnull fabricIndex  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@end
...
@property (nonatomic, copy, getter=getNewState) NSNumber * _Nonnull newState  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@end
...
@property (nonatomic, copy) NSNumber * _Nonnull caseSessionsPerFabric  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSNumber * _Nonnull subscriptionsPerFabric  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@end
...
@property (nonatomic, copy, getter=getNewState) NSNumber * _Nonnull newState  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSNumber * _Nonnull reason  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSNumber * _Nullable targetSoftwareVersion  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@end
...
@property (nonatomic, copy) NSNumber * _Nonnull failSafeExpiryLengthSeconds  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@property (nonatomic, copy) NSNumber * _Nonnull maxCumulativeFailsafeSeconds  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@end
...
@property (nonatomic, copy) NSNumber * _Nullable offPremiseServicesReachableIPv4  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSNumber * _Nullable offPremiseServicesReachableIPv6  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
...
@property (nonatomic, copy) NSNumber * _Nonnull activeTimestampPresent  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@property (nonatomic, copy) NSNumber * _Nonnull pendingTimestampPresent  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
...
@property (nonatomic, copy) NSNumber * _Nonnull meshLocalPrefixPresent  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
...
@property (nonatomic, copy) NSNumber * _Nonnull securityPolicyPresent  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
...
@property (nonatomic, copy, getter=getNewPosition) NSNumber * _Nonnull newPosition  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@end
...
@property (nonatomic, copy, getter=getNewPosition) NSNumber * _Nonnull newPosition  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@property (nonatomic, copy) NSNumber * _Nonnull currentNumberOfPressesCounted  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@end
...
@property (nonatomic, copy) NSNumber * _Nonnull totalNumberOfPressesCounted  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@end
...
@property (nonatomic, copy) NSNumber * _Nonnull groupKeySetID  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
@property (nonatomic, copy) NSNumber * _Nonnull groupKeySecurityPolicy  API_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1));
...
@property (nonatomic, copy) MTRContentLauncherClusterDimensionStruct * _Nullable size  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@end
...
@property (nonatomic, copy) MTRContentLauncherClusterStyleInformationStruct * _Nullable background  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) MTRContentLauncherClusterStyleInformationStruct * _Nullable logo  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) MTRContentLauncherClusterStyleInformationStruct * _Nullable progressBar  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) MTRContentLauncherClusterStyleInformationStruct * _Nullable splash  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) MTRContentLauncherClusterStyleInformationStruct * _Nullable waterMark  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@end
...
@property (nonatomic, copy) MTRApplicationLauncherClusterApplicationStruct * _Nonnull application  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
...
@property (nonatomic, copy) NSNumber * _Nullable optionalFabricSensitiveInt8u  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSNumber * _Nullable nullableFabricSensitiveInt8u  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSNumber * _Nullable nullableOptionalFabricSensitiveInt8u  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSString * _Nonnull fabricSensitiveCharString  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) MTRUnitTestingClusterSimpleStruct * _Nonnull fabricSensitiveStruct  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSArray * _Nonnull fabricSensitiveInt8uList  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSNumber * _Nonnull fabricIndex  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@end
...
@property (nonatomic, copy) NSNumber * _Nonnull a  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) NSNumber * _Nonnull b  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@property (nonatomic, copy) MTRUnitTestingClusterSimpleStruct * _Nonnull c  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
@end
...
@property (nonatomic, copy) MTRUnitTestingClusterSimpleStruct * _Nonnull arg4  API_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
